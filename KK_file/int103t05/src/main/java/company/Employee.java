...
public class Employee extends Person {
    public final static Comparator<Employee> EMPLOYEE_COMPARATOR = new EmployeeComparator();
    ...
    //anonymous class of nested class
    //nested class -> static -> anonymous class if not have name
    //nested class -> non static(inner class) -> anonymous class if not have name
